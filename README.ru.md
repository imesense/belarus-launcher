...
Специализированный лаунчер для модификации Беларусь для загрузки и обновления модификации, просмотра текущих новостей и запуска модификации с сервера

![Лаунчер](./doc/launcher.ru.png)
...
- **Загрузка** модификации с обновлениями: лаунчер позволяет легко, быстро загружать модификацию и автоматически проверять наличие обновлений
...
Лаунчер обеспечивает простоту использования и лёгкий доступ к необходимым функциям, чтобы игрок мог в полной мере насладиться игровым процессом
